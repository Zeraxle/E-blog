    ...
    return (
        <div className="profile-container">
            ...
            <div className="button-group">
                ...
                <button className="profile-btn" onClick={() => setActiveSection('followers')}>Following</button>
                <button className="profile-btn" onClick={() => setActiveSection('following')}>Followers</button>
            </div>
                ...
                <table className="profile-table">
                    <tbody>
                        {userFollowers.map(post => (
                            <tr key={post.id}>
                                <td>You are following <Link to={`/display/user/${post.id}`}>{post.username}</Link></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <table className="profile-table">
                    <tbody>
                        {userFollowing.map(post => (
                            <tr key={post.id}>
                                <td> <Link to={`/display/user/${post.id}`}>{post.username}</Link> Follows you.</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
